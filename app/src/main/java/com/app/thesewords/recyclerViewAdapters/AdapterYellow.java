...
public class AdapterYellow extends RecyclerView.Adapter<AdapterYellow.MyView> {
                ...
                public void onClick(View view) {
                    if (recyclerViewInterface != null) {
                        ...
                        if (pos != RecyclerView.NO_POSITION){
                            recyclerViewInterface.onItemClickYellow(view, pos);
                        }
                    }
                }
            });
    ...
    public AdapterYellow(ArrayList<CardModel> cardModalArrayList,
